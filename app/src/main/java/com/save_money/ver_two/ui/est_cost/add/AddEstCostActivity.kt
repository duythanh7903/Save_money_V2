package com.save_money.ver_two.ui.est_cost.add
...
import com.save_money.ver_two.databinding.ActivityAddEstCostBinding
...
import com.save_money.ver_two.ui.est_cost.list.EstCostsActivity
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class AddEstCostActivity: BaseActivity<ActivityAddEstCostBinding>(R.layout.activity_add_est_cost) {
    ...
    private fun clickViews() = binding.apply {
        iconList.click {
            startActivity(Intent(this@AddEstCostActivity, EstCostsActivity::class.java))
        }
    ...
    private fun observer() = viewModel.apply {
        childCat.observe(this@AddEstCostActivity) { list ->
        ...
        parentCat.observe(this@AddEstCostActivity) { list ->
