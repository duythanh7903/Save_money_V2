package com.save_money.ver_two.ui.real_income.add
...
import com.save_money.ver_two.databinding.ActivityAddRealIncomeBinding
...
@AndroidEntryPoint
class AddRealIncomeActivity :
    BaseActivity<ActivityAddRealIncomeBinding>(R.layout.activity_add_real_income) {
    ...
    private fun clickViews() = binding.apply {
        iconList.click {
            startActivity(Intent(this@AddRealIncomeActivity, IncomesActivity::class.java))
        }
    ...
    private fun observer() = viewModel.apply {
        childCat.observe(this@AddRealIncomeActivity) { list ->
        ...
        parentCat.observe(this@AddRealIncomeActivity) { list ->
